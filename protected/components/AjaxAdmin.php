	    				...
	    				if ( $this->insertData("{{order}}",$params)){
		    		        ...
		    		        if($transaction_type=="delivery"){
		    		        	$params_address=array(	    				  
			    				  ...
			    				  'google_lat'=>isset($this->data['map_accurate_address_lat'])?$this->data['map_accurate_address_lat']:'',
		    				      'google_lng'=>isset($this->data['map_accurate_address_lng'])?$this->data['map_accurate_address_lng']:'',
